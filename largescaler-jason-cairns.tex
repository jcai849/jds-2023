...
It can take advantage of multicore machines, with the ability to be run in parallel. The package \pkg{biglasso} described in detail in \citet{zeng2017biglasso}.
